<template>
  <el-dialog :title="title" v-model="visible" width="680px" append-to-body @closed="resetForm">
        ...
        <el-col :span="24">
          <el-form-item prop="menuType">
            ...
            <el-radio-group v-model="form.menuType">
              <el-radio v-for="item in menuTypeDict" :key="item.dictValue" :label="item.dictValue">
                {{ item.dictLabel }}
              </el-radio>
            </el-radio-group>
          </el-form-item>
