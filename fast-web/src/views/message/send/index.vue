    ...
    <div class="content-card">
      ...
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px" style="max-width: 800px">
        <el-form-item label="消息标题" prop="messageTitle">
          <el-input v-model="form.messageTitle" placeholder="请输入消息标题" maxlength="100" show-word-limit />
        </el-form-item>
        ...
        <el-form-item label="接收人" prop="receiverIds">
          <el-select v-model="form.receiverIds" multiple filterable placeholder="请选择接收人" style="width: 100%">
        ...
        <el-form-item label="消息内容" prop="messageContent">
          <RichTextEditor v-model="form.messageContent" placeholder="请输入消息内容" height="300px" />
        </el-form-item>
        <el-form-item>
